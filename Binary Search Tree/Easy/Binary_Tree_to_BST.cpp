...
public:
    ...
    void convertingBTtoBST(Node *root, vector<int> inOrdElements, int &i)
    {
        if (root)
        {
            convertingBTtoBST(root->left, inOrdElements, i);
            root->data = inOrdElements[i++];
            convertingBTtoBST(root->right, inOrdElements, i);
        }
    }
    ...
    Node *binaryTreeToBST(Node *root)
    {
        ...
        sort(inOrdElements.begin(), inOrdElements.end());

        int i = 0;
        convertingBTtoBST(root, inOrdElements, i);
